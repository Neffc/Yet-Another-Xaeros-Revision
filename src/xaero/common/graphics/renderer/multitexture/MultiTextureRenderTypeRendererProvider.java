...
public class MultiTextureRenderTypeRendererProvider {
   ...
   public MultiTextureRenderTypeRenderer getRenderer(IntConsumer textureBinderShader, IntConsumer textureBinder, class_1921 renderType) {
      return this.getRenderer(textureBinderShader, textureBinder, null, renderType);
   }

   public MultiTextureRenderTypeRenderer getRenderer(
      IntConsumer textureBinderShader, IntConsumer textureBinder, Runnable textureFinalizer, class_1921 renderType
   ) {
