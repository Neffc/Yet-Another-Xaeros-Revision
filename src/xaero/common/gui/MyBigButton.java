...
public class MyBigButton extends class_4185 {
   ...
   public MyBigButton(int id, int par1, int par2, class_2561 par4Str, class_4241 onPress) {
      this(id, par1, par2, (ModOptions)null, par4Str, onPress);
   }

   public MyBigButton(int id, int par1, int par2, int par3, int par4, int par5, class_2561 par6Str, class_4241 onPress) {
      super(par1, par2, par3, par4, par6Str, onPress, field_40754);
      this.modOptions = null;
      this.id = id;
   }

   public MyBigButton(int id, int par1, int par2, ModOptions par4EnumOptions, class_2561 par5Str, class_4241 onPress) {
